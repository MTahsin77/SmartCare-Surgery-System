...
if __name__ == "__main__":
    root_folders = [
        ...
        r'E:\SmartCare-Surgery-System\smartcare_api',
    ]
    
    additional_files = [
        r'E:\SmartCare-Surgery-System\docker-compose.yml',
        r'E:\SmartCare-Surgery-System\Dockerfile',	
        r'E:\SmartCare-Surgery-System\requirements.txt',
        r'E:\SmartCare-Surgery-System\.env',
    ]
    
    output_txt = 'all_code.txt'
    
    code_files = get_all_code_files(root_folders)
    code_files.extend(additional_files)
